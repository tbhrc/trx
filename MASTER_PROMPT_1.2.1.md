...
If you cannot actually run them, then you must reason about imports, names and types so that these entry points still work.
...
review and understand and study what this app is all about then update the @version to 1.2.1 and update the @date to the current date UAE time.

create new folder under docs/v1.2.1 
